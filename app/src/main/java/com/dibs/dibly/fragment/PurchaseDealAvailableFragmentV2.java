 ...
 */
public class PurchaseDealAvailableFragmentV2 extends Fragment {
    ...
    private void notifyListData() {
        listDeal.clear();
        List<ObjectDeal> list = DealController.getDealByDealType(getActivity(), Const.DEALTYPE.DEAL_AVAILABLE);
