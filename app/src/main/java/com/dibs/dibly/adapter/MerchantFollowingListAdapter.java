 ...
 */
public class MerchantFollowingListAdapter extends BaseAdapter {
    ...
    public MerchantFollowingListAdapter(Activity activity, List<MerchantList> list) {
        ...
        optionsCover = new DisplayImageOptions.Builder()
                ...
                .showImageOnLoading(R.color.white).showImageOnFail(R.drawable.merchant_cover_sm)
                .cacheInMemory(true)
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = this.layoutInflater.inflate(R.layout.row_merchant_following_list, null);
