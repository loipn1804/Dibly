 ...
 */
public class FollowingDealsMerchantAdapter extends BaseAdapter {
    ...
    public FollowingDealsMerchantAdapter(Activity activity, List<ObjectDeal> listDeal) {
        ...
        options = new DisplayImageOptions.Builder().cacheInMemory(true).imageScaleType(ImageScaleType.EXACTLY).
                bitmapConfig(Bitmap.Config.RGB_565).showImageForEmptyUri(R.drawable.merchant_cover_sm).showImageOnFail(R.drawable.merchant_cover_sm).
                showImageOnLoading(R.color.white).cacheOnDisk(true).build();
