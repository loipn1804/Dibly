...
/** 
 * DAO for table OBJECT_DEAL_SEARCH.
*/
public class ObjectDealSearchDao extends AbstractDao<ObjectDealSearch, Long> {

    public static final String TABLENAME = "OBJECT_DEAL_SEARCH";

    /**
     * Properties of entity ObjectDealSearch.<br/>
    ...
    */
    public static class Properties {
        ...
        public final static Property Is_longterm = new Property(12, Integer.class, "is_longterm", false, "IS_LONGTERM");
    ...
    public ObjectDealSearchDao(DaoConfig config) {
        super(config);
    }
    
    public ObjectDealSearchDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'OBJECT_DEAL_SEARCH' (" + //
                ...
                "'IS_LONGTERM' INTEGER," + // 12: is_longterm
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'OBJECT_DEAL_SEARCH'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, ObjectDealSearch entity) {
        stmt.clearBindings();
        ...
        Integer is_longterm = entity.getIs_longterm();
        if (is_longterm != null) {
            stmt.bindLong(13, is_longterm);
        }
    ...
    /** @inheritdoc */
    @Override
    public ObjectDealSearch readEntity(Cursor cursor, int offset) {
        ObjectDealSearch entity = new ObjectDealSearch( //
            ...
            cursor.isNull(offset + 12) ? null : cursor.getInt(offset + 12), // is_longterm
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, ObjectDealSearch entity, int offset) {
        ...
        entity.setIs_longterm(cursor.isNull(offset + 12) ? null : cursor.getInt(offset + 12));
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(ObjectDealSearch entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(ObjectDealSearch entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
